...
public class DataManager {
    ...
    private List<collision.questsolz.firstapp.CourseInfo> mCourses = new ArrayList<>();
    ...
    public String getCurrentUserName() {
        return "Chipuka Jaison";
    }

    public String getCurrentUserEmail() {
        return "chipukajaison@gmail.com";
    }
    ...
    public List<collision.questsolz.firstapp.CourseInfo> getCourses() {
        return mCourses;
    }

    public collision.questsolz.firstapp.CourseInfo getCourse(String id) {
        for (collision.questsolz.firstapp.CourseInfo course : mCourses) {
    ...
    public List<NoteInfo> getNotes(collision.questsolz.firstapp.CourseInfo course) {
    ...
    public int getNoteCount(collision.questsolz.firstapp.CourseInfo course) {
        int count = 0;
        for(NoteInfo note:mNotes) {
            if(course.equals(note.getCourse()))
                count++;
    ...
    public void initializeExampleNotes() {
        ...
        collision.questsolz.firstapp.CourseInfo course = dm.getCourse("android_intents");
    ...
    private collision.questsolz.firstapp.CourseInfo initializeCourse1() {
        ...
        return new collision.questsolz.firstapp.CourseInfo("android_intents", "Android Programming with Intents", modules);
    }

    private collision.questsolz.firstapp.CourseInfo initializeCourse2() {
        List<ModuleInfo> modules = new ArrayList<>();
        ...
        return new collision.questsolz.firstapp.CourseInfo("android_async", "Android Async Programming and Services", modules);
    }

    private collision.questsolz.firstapp.CourseInfo initializeCourse3() {
        List<ModuleInfo> modules = new ArrayList<>();
        ...
        return new collision.questsolz.firstapp.CourseInfo("java_lang", "Java Fundamentals: The Java Language", modules);
    }

    private collision.questsolz.firstapp.CourseInfo initializeCourse4() {
        List<ModuleInfo> modules = new ArrayList<>();
        ...
        return new collision.questsolz.firstapp.CourseInfo("java_core", "Java Fundamentals: The Core Platform", modules);
    }
    //endregion
